export const crazyTimeGuide = {
  ...
  stats: [
    ...
    { label: "Game Type", value: "Live Game Show" },
  ...
  sections: [
    ...
    },
    {
      ...
      faq: [
        ...
        },
        {
          ...
          answer:
            "Crazy Time dealers are live Evolution presenters who host the studio game, manage the betting window, spin the wheel and guide bonus rounds.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, many Evolution casinos offer Crazy Time on mobile. Availability, table limits and presentation can vary by operator and region.",
        },
        {
    ...
    },
    {
      ...
      related: [
        {
          title: "Lightning Roulette Guide",
          href: "/guides/lightning-roulette",
          description: "Lightning multipliers, RTP and Evolution casino availability.",
        },
        {
        ...
        {
          title: "Lightning Dice Guide",
          href: "/guides/lightning-dice",
          description: "Three-dice mechanics, lightning multipliers and volatility.",
        },
      ],
    },
  ],
