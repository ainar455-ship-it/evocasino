...
export const metadata: Metadata = canonicalMetadata("/games/lightning-roulette");

export default function LightningRoulettePage() {
  const all = getAllCasinos();
  const rows = filterAndRank(all, { show: "lightning-roulette" });

  return (
    <main style={{ padding: 24, maxWidth: 980, margin: "0 auto" }}>
      <h1 style={{ fontSize: 34, fontWeight: 800 }}>Best Lightning Roulette Casinos</h1>
      <p style={{ marginTop: 10, fontSize: 16 }}>
        Ranked by derived Evolution Score. Only casinos offering Evolution Lightning Roulette are included.
      </p>
