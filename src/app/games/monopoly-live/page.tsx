...
export default function MonopolyLivePage() {
  ...
  const rows = filterAndRank(all, { show: "monopoly-live" });

  return (
    <main style={{ padding: 24, maxWidth: 980, margin: "0 auto" }}>
      <h1 style={{ fontSize: 34, fontWeight: 800 }}>Best Monopoly Live Casinos</h1>
      <p style={{ marginTop: 10, fontSize: 16 }}>
        Ranked by derived Evolution Score. Only casinos offering Evolution Monopoly Live are included.
      </p>
