...
const footerGuideLinks = guideRegistry.slice(0, 3);
          ...
          <div className="home-shell home-hero-grid">
            ...
            {featuredGuide && (
              <article className="home-feature-card" aria-label="Featured guide">
                ...
                <p>
                  A complete editorial breakdown of Evolution's flagship game show - bonus
                  mechanics, RTP per segment, and bankroll discipline.
                </p>
      ...
      <footer className="site-footer">
        <div className="site-footer-shell">
          <div>
            ...
            <p>
              Premium editorial guides and reviews focused on Evolution live casino games,
              transparent rankings, and trusted casino context.
            </p>
          </div>

          <nav aria-label="Footer guides">
            <h2>Guides</h2>
            {footerGuideLinks.map((guide) => (
              <a key={guide.slug} href={`/guides/${guide.slug}`}>
                {guide.title.replace(" on Evolution Live", "")}
              </a>
            ))}
          </nav>

          <nav aria-label="Footer casino links">
            <h2>Casinos</h2>
